...
public class CustomerDetailDaoImpl extends JdbcTemplate implements
    ...
    public List procCustomerDetail(String customerDetailId, String email, String password, String customerTitle, String firstName,
        ...
        call.addDeclaredParameter(new SqlParameter("IN_FIRST_NAME", Types.VARCHAR));
        call.addDeclaredParameter(new SqlParameter("IN_MIDDLE_NAME", Types.VARCHAR));
        call.addDeclaredParameter(new SqlParameter("IN_LAST_NAME", Types.VARCHAR));
        ...
        inp.put("IN_FIRST_NAME", firstName);
        inp.put("IN_MIDDLE_NAME", middleName);
        inp.put("IN_LAST_NAME", lastName);
