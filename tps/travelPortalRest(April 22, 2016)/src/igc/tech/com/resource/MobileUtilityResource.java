...
public class MobileUtilityResource {
    ...
    public Response registerUser(CustomerDetailModel customerDetailModel) {
        ...
        Map map = (Map) customerDetailDao.procCustomerDetail(null, customerDetailModel.getEmail(), null, null, customerDetailModel.getFirstName(), customerDetailModel.getMiddleName(), customerDetailModel.getLastName(),
                customerDetailModel.getContactNo(), null, customerDetailModel.getAppVersion(), customerDetailModel.getDeviceEmail(), customerDetailModel.getDeviceId(), customerDetailModel.getRegKey(),
    ...
    public Response checkNumberRegistered(CustomerDetailModel customerDetailModel) {
        ...
        List<CustomerDetailModel> customerDetailModels = new CustomerDetailMapper().mapList(customerDetailDao.procCustomerDetail(null, null, null, null, null, null, null, customerDetailModel.getContactNo(), null, null, null, null, null, null, null, null, null, null, "s"));
    ...
    public Response otpRequest(CustomerDetailModel customerDetailModel) {
        ...
        List<CustomerDetailModel> customerDetailModels = new CustomerDetailMapper().mapList(customerDetailDao.procCustomerDetail(null, customerDetailModel.getEmail(), null, null, null, null, null, customerDetailModel.getContactNo(), null, null, null, null, null, null, null, null, null, null, "s"));
        ...
        customerDetailDao.procCustomerDetail(customerDetailModels.get(0).getCustomerDetailId(), null, null, null, null, null, null,
    ...
    public Response confirmOtpRequest(CustomerDetailModel customerDetailModel) {
        ...
        List<CustomerDetailModel> customerDetailModels = new CustomerDetailMapper().mapList(customerDetailDao.procCustomerDetail(null, customerDetailModel.getEmail(), null, null, null, null, null,
