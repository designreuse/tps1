...
<head>
    ...
    <base href="${pageContext.request.contextPath}/dayDetail/"/>
        ...
        <div class="modal-content">
            <form action="delete" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete Day Detail Activity</h4>
                </div>
                <div class="modal-body">

                    Are you sure you want to delete this Day Detail Activity? This
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label"
                                                               for="activityDetailId">Activity</label>
                                                        <div class="controls">
                                                            <select id="activityDetailId" name="activityDetailId"
                                                                    data-rel="chosen">

                                                                <option value="">SELECT</option>
                                                                <c:forEach items="${activityDetailList}" var="data">
                                                                    <option value="${data.activityDetailId}">${data.description}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box span12">
                                            ...
                                            <div class="box-content">
                                                <table class="table delete-package">
                                                    ...
                                                    <tbody>
                                                    <%int count = 0; %>
                                                    <c:forEach items="${dayDetailList}" var="data">
                                                        <%count++; %>
                                                        <tr>
                                                            <td><%=count%>.</td>
                                                            <td class="center">${data.activityName}</td>

                                                            <td class="center"><a class="open btn btn-danger"
                                                                                  title="Delete Activity"
                                                                                  data-toggle="modal"
                                                                                  data-target="#myModal_del"
                                                                                  data-id="${data.dayDetailId}"
                                                                                  data-rel="tooltip">
                                                                <i class="halflings-icon white trash"></i>
                                                            </a></td>
                                                        </tr>
