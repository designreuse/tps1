...
<head>
    ...
    <base href="${pageContext.request.contextPath}/region/"/>
...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
                        ...
                        <div class="box-content">
                            <form id="form1" class="form-horizontal" method="post" action="${mode}">
                                <fieldset>
                                    ...
                                    <input type="hidden" name="regionId" value="${regionMap.regionId}">
                                    <div class="control-group">
                                        <label class="control-label" for="country">Country</label>
                                        <div class="controls">
                                            <select id="country" name="countryId" data-rel="chosen">
                                                <c:forEach items="${countryList}" var="data">
                                                    <option value="${data.countryId}"
                                                            <c:if test="${data.countryId==regionMap.countryId}">selected="selected"</c:if>  >${data.countryName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" name="regionName"
                                                   type="text" value="${regionMap.regionName}">
                                        </div>
                                    </div>
            ...
            <div class="test">
                <a href="add" title="Add Country" data-rel="tooltip" class="btn btn-warning">Add Region</a>
            </div>
            <!-- 			end add button -->
                            ...
                            <c:forEach items="${regionList}" var="data">
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-info" href="edit/${data.regionId}" title="Edit"
                                           data-rel="tooltip">
                                        ...
                                        <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                           ...
                                           data-id="${data.regionId}" data-rel="tooltip">
