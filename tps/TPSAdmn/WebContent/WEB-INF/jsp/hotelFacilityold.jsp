        ...
        <div class="modal-content">
            <form action="delete" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete Hotel Facility</h4>
                </div>
                <div class="modal-body">

                    Are you sure you want to delete this Hotel Facility? This action cannot be undone!
    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <c:if test="${mode=='edit' || mode=='add'}">
                ...
                <div class="test">
                    <a href="view" title="View Hotel Facility" data-rel="tooltip" class="btn btn-warning">View Hotel
                        Facility</a>
                </div>
                    ...
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    test="${mode=='add'}">Add</c:if><c:if test="${mode=='edit'}">Edit</c:if> Hotel
                                Facility </h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <form id="form1" class="form-horizontal" method="post" action="${mode}">
                                <fieldset>
                                    ...
                                    <input type="hidden" name="hotelFacilityId"
                                           value="${hotelFacilityMap.hotelFacilityId}">
                                    <div class="control-group">
                                        <label class="control-label" for="hotelDetailId">Hotel Name</label>
                                        <div class="controls">
                                            <select id="hotelDetailId" name="hotelDetailId" data-rel="chosen">
                                                ...
                                                <c:forEach items="${hotelDetailList}" var="data">
                                                    <option value="${data.hotelDetailId}"
                                                            <c:if test="${data.hotelDetailId==hotelFacilityMap.hotelDetailId}">selected="selected"</c:if>  >${data.hotelName},${data.areaName},${data.regionName},${data.countryName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group hidden-phone">
                                        <label class="control-label" for="description">Facility Description</label>
                                        <div class="controls box-content">
                                            <textarea id="textEditor" class="cleditor" name="description"
                                                      rows="3">${hotelFacilityMap.description}</textarea>
                                        </div>
                                    </div>
            ...
            <c:if test="${mode=='view'}">
                ...
                <div class="test">
                    <a href="add" title="Add Hotel Facility" data-rel="tooltip" class="btn btn-warning">Add Hotel
                        Facility</a>
                </div>
                ...
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white user"></i><span class="break"></span>Hotel Facility List
                            </h2>
                            <div class="box-icon">
                                <a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
                                <a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                <%int count = 0; %>
                                <c:forEach items="${hotelFacilityList}" var="data">
                                    <%count++; %>
                                    <tr>
                                        <td><%=count%>.</td>
                                        <td>${data.hotelName},${data.areaName},${data.regionName},${data.countryName}</td>
                                        <td>${data.description}</td>

                                        <td class="center">

                                            <a class="btn btn-info" href="edit/${data.hotelFacilityId}" title="Edit"
                                               data-rel="tooltip">
                                            ...
                                            <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                               ...
                                               data-id="${data.hotelFacilityId}" data-rel="tooltip">
