...
<head>
    ...
    <base href="${pageContext.request.contextPath}/packageInfo/"/>
        ...
        <div class="modal-content">
            <form action="delete" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete Package Info</h4>
                </div>
                <div class="modal-body">

                    Are you sure you want to delete this Package Info? This action cannot be undone!
    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <c:if test="${mode=='edit' || mode=='add' || mode=='detail' }">
                ...
                <div class="test">
                    <a href="view" title="view Package Info" data-rel="tooltip" class="btn btn-success">View Package
                        Info</a>
                </div>
                    ...
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    ...
                                    test="${mode=='detail'}">View</c:if> Package Info </h2>
                            <div class="box-icon">
                            ...
                            <form id="form1" class="form-horizontal" method="post" action="${mode}">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><input type="hidden" name="packageInfoId"
                                                                     value="${packageInfoMap.packageInfoId}">
                                            <input class="input-xlarge focused" id="focusedInput" name="description"
                                                   type="text" value="${packageInfoMap.description}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" name="noOfDays"
                                                   type="text" value="${packageInfoMap.noOfDays}">
                                        </div>
                                    </div>


                                    <div class="control-group">
                                        <label class="control-label" for="focusedInput">No of Nights</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" name="noOfNights"
                                                   type="text" value="${packageInfoMap.noOfNights}">
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="focusedInput">Total Days</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" name="totalDays"
                                                   type="text" value="${packageInfoMap.totalDays}">
                                        </div>
                                    </div>


                                    <div class="control-group hidden-phone">
                                        <label class="control-label" for="textarea2">Package Details</label>
                                        <div class="controls box-content">
                                            <textarea id="textarea2" class="cleditor" name="packageDetails"
                                                      rows="3">${packageInfoMap.packageDetails}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <select id="clientName" name="clientDetailId" data-rel="chosen">
                                            ...
                                            <c:forEach items="${clientDetailList}" var="data">
                                                <option value="${data.clientDetailId}"
                                                        <c:if test="${data.clientDetailId==packageInfoMap.clientDetailId}">selected="selected"</c:if> >${data.clientName},${data.companyName }</option>
                                            </c:forEach>
                                        </select>
                                    </div>
            ...
            <c:if test="${mode=='view'}">
                ...
                <div class="test">
                    <a href="add" title="Add Package Info" data-rel="tooltip" class="btn btn-warning">Add Package
                        Info</a>
                </div>
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white user"></i><span class="break"></span>Package Info list
                            </h2>
                            <div class="box-icon">
                                <a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
                                <a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <c:forEach items="${packageInfoList}" var="data">
                                    ...
                                    <tr>
                                        ...
                                        <td>${data.clientName},${data.companyName}</td>
                                        <td class="center">${data.noOfDays}</td>
                                        <td class="center">${data.noOfNights}</td>
                                        <td class="center">${data.totalDays}</td>

                                        <td class="center">
                                            <a class="detail btn btn-success" href="detail/${data.packageInfoId}"
                                               title="Detail View" data-rel="tooltip">
                                                <i class="white icon-eye-open"></i>
                                            </a>
                                            <a class="btn btn-info" href="edit/${data.packageInfoId}" title="Edit"
                                               data-rel="tooltip">
                                            ...
                                            <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                               ...
                                               data-id="${data.packageInfoId}" data-rel="tooltip">
