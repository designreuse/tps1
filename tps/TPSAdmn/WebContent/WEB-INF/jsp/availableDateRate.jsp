...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Available Date and Rate</title>
    ...
    <base href="${pageContext.request.contextPath}/availableDateRate/"/>
        ...
        <div class="modal-content">
            <form action="delete" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete Available Date and Rate</h4>
                </div>
                <div class="modal-body">

                    Are you sure you want to delete this Available Date and Rate? This action cannot be undone!
...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
                    ...
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    test="${mode=='add'}">Add</c:if><c:if test="${mode=='edit'}">Edit</c:if> Available
                                Date and Rate </h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <form id="form1" class="form-horizontal" method="post" action="${mode}">
                                <fieldset>
                                    ...
                                    <input type="hidden" name="availableDateRateId"
                                           value="${availableDateRateMap.availableDateRateId}">
                                            ...
                                            <select id="packageInfoId" name="packageInfoId" data-rel="chosen">
                                                ...
                                                <c:forEach items="${packageInfoList}" var="data">
                                                    <option value="${data.packageInfoId}"
                                                            <c:if test="${data.packageInfoId==availableDateRateMap.packageInfoId}">selected="selected"</c:if>  >${data.description}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="availableDate">Available Date</label>
                                        <div class="controls">
                                            <input type="text" class="input-xlarge datepicker" id="availableDate"
                                                   name="availableDate" value="${availableDateRateMap.availableDate}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" id="rate" name="rate"
                                                   type="text" value="${availableDateRateMap.rate}">
                                        </div>
                                    </div>
            ...
            <div class="test">
                <a href="add" title="Add Available Date and Rate" data-rel="tooltip" class="btn btn-warning">Add
                    Available Date and Rate</a>
            </div>
            <!-- 			end add button -->
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>Available Date and Rate
                            List</h2>
                        <div class="box-icon">
                            <a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
                            <a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
                    ...
                    <div class="box-content">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <tbody>
                            <%int count = 0; %>
                            <c:forEach items="${availableDateRateList}" var="data">
                                <%count++; %>
                                <tr>
                                    <td><%=count%>.</td>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-info" href="edit/${data.availableDateRateId}" title="Edit"
                                           data-rel="tooltip">
                                        ...
                                        <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                           ...
                                           data-id="${data.availableDateRateId}" data-rel="tooltip">
