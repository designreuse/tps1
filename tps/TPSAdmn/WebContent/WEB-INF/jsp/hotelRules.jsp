...
<head>
    ...
    <base href="${pageContext.request.contextPath}/hotelRules/"/>
        ...
        <div class="modal-content">
            <form action="delete" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delete Room Rules</h4>
                </div>
                <div class="modal-body">

                    Are you sure you want to delete this Room Rules? This action cannot be undone!
    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
                ...
                <div class="row-fluid sortable">
                    <div class="box span12" id="box">
                        ...
                        <div class="box-content">
                            <form id="formArea" class="form-horizontal" method="post" action="viewHotelRules">
                                <fieldset>
            ...
            <c:if test="${mode=='update' }">
                ...
                <%--<div class="test">
                    <a href="view" title="View Nearest Area" data-rel="tooltip" class="btn btn-success">View Hotel Rules </a>
                </div>--%>
                <div class="row-fluid sortable">
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    test="${mode=='add'}">Add</c:if><c:if test="${mode=='edit'}">Edit</c:if> ${hotelName} Rules
                            </h2>
            ...
            <%--<c:if test="${mode=='viewHotelRules'}">
                <div class="test">
                    <a href="add/${hotelId}" title="Add Hotel Rules" data-rel="tooltip" class="btn btn-warning">Add Hotel Rules </a>
                </div>

                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white list"></i><span class="break"></span>Hotel Rules List
                            </h2>
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                <c:forEach items="${hotelRulesList}" var="data" varStatus="count">
                                    <tr>
                                        <td>${count.count}.</td>
...
<script type="text/javascript">
    ...
    /*$(document).ready(function(){
        ...
        <c:forEach var="hotelRules" items="${hotelRulesList}">

        <c:choose>
        <c:when test="${hotelRules.type=='HOTEL'}">


        hotel=hotel+'<tr>'+
                '<td>'+hotelIndex+'.</td>'+
                '<td>${hotelRules.rulesDesc}'+
                '<input type="hidden" value="${hotelRules.hotelRulesId}" name="hotelRulesId">'+
                '<input type="hidden" value="${hotelRules.rulesId}" name="rulesId"></td>'+
                '<td><input type="checkbox" name="active" value="${hotelRules.rulesId}" <c:if test="${hotelRules.active=='Y'}">checked</c:if>></td>'+
                '</tr>';
        ...
        <c:when test="${hotelRules.type=='ROOM'}">
        room=room+'<tr>'+
                '<td>'+roomIndex+'.</td>'+
                '<td>${hotelRules.rulesDesc}'+
                '<input type="hidden" value="${hotelRules.hotelRulesId}" name="hotelRulesId">'+
