        ...
        <div class="modal-content">
            <form action="delete" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input id="deleteId" type="text" style="display: none" value="" name="roleId">
...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <div class="test">
                <a href="add" title="Add room Facility" data-rel="tooltip" class="btn btn-warning">Add Role </a>
            </div>

            <c:if test="${mode!='view'}">
                <div class="test">
                    <a href="view" title="View room Facility" data-rel="tooltip" class="btn btn-success">View Role </a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                               ...
                                               data-id="${data.roleId}" data-hid="${data.roleId}"
                                               data-rel="tooltip">
