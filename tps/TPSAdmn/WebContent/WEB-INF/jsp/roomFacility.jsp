...
<head>
    ...
    <base href="${pageContext.request.contextPath}/roomFacility/"/>
...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <%--<div class="test">
                <a href="add" title="Add room Facility" data-rel="tooltip" class="btn btn-warning">Add Room
                    facility </a>
            </div>--%>

            <c:if test="${mode!='view'}">
                <div class="test">
                    <a href="view" title="View room Facility" data-rel="tooltip" class="btn btn-success">Select Hotel </a>
                </div>
                    ...
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    test="${mode=='add'}">Add</c:if><c:if test="${mode=='edit'}">Edit</c:if> ${roomDesc} Facility
                            </h2>
...
<p>Hotel: ${hotelName}</p>
                                    ...
                                    <table class="table table-striped table-bordered bootstrap-datatable " id="popularPlace">
                                        ...
                                        <c:forEach items="${roomFacilityList}" var="roomFacility" varStatus="count">


                                            <tr>
                                                <td>${count.count}.</td>
                                                <td>${roomFacility.facilityDesc}</td>
                                                <input type="hidden" value="${roomFacility.roomFacilityId}" name="roomFacilityId">
                                                <input type="hidden" value="${roomFacility.facilityId}" name="facilityId"></td>
                                                <td><input type="checkbox" name="active" value="${roomFacility.facilityId}" <c:if test="${roomFacility.active=='Y'}">checked</c:if>></td>
