...
<head>
    ...
    <base href="${pageContext.request.contextPath}/popularPlace/"/>
        ...
        <div class="modal-content">
            <form action="delete" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input id="deleteId" type="text" style="display: none" value="" name="popularPlaceId">
    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <c:if test="${mode=='edit' || mode=='add'  }">
                <div class="test">
                    <a href="view" title="View Popular Place" data-rel="tooltip" class="btn btn-success">View Popular Place </a>
                </div>
                    ...
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    test="${mode=='add'}">Add</c:if><c:if test="${mode=='edit'}">Edit</c:if> Role
                            </h2>
                        ...
                        <div class="box-content">
                            <form id="form1" class="form-horizontal" method="post" action="${mode}">
                                <fieldset>
                                    ...
                                    <input type="hidden" name="popularPlaceId" value="${popularPlaceMap.popularPlaceId}">

                                    <div class="control-group">
                                        <label class="control-label" for="place">Place</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="place" name="place"
                                                   type="text" value="${popularPlaceMap.place}" required>
                                        </div>
                                    </div>
...
<c:if test="${mode=='view'}">
            <div class="test">
                <a href="add" title="Add Popular Place" data-rel="tooltip" class="btn btn-warning">Add Popular Place </a>
            </div>

                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white user"></i><span class="break"></span>Popular Place List
                            </h2>
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                <c:forEach items="${popularPlaceList}" var="data" varStatus="count">
                                    <tr>
                                        <td>${count.count}.</td>
                                        ...
                                        <td class="center">
                                            ...
                                            <a class="btn btn-info" href="edit/${data.popularPlaceId}" title="Edit"
                                               data-rel="tooltip">
                                            ...
                                            <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                               ...
                                               data-id="${data.popularPlaceId}" data-rel="tooltip">
