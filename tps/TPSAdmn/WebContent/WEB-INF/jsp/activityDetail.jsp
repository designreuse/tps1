        ...
        <div class="modal-content">
            <form action="delete" method="post">
                ...
                <div class="modal-body">
                    ...
                    Are you sure you want to delete this Activity Detail? This action cannot be undone!
...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
                    ...
                    <div class="box span12" id="box">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white edit"></i><span class="break"></span><c:if
                                    test="${mode=='add'}">Add</c:if><c:if test="${mode=='edit'}">Edit</c:if> Activity
                                Detail </h2>
                            <div class="box-icon">
                            ...
                            <form id="form1" class="form-horizontal" method="post" action="${mode}">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><input type="hidden" name="activityDetailId"
                                                                     value="${activityDetailMap.activityDetailId}">
                                            <input class="input-xlarge focused" id="description" name="description"
                                                   type="text" value="${activityDetailMap.description}">
                                        </div>
                                    </div>
            ...
            <div class="test">
                <a href="add" title="Add Activity Detail" data-rel="tooltip" class="btn btn-warning">Add Activity
                    Detail</a>
            </div>
            <!-- 			end add button -->
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>Activity Detail List
                        </h2>
                        <div class="box-icon">
                            <a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
                            <a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
                            ...
                            <c:forEach items="${activityDetailList}" var="data">
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-info" href="edit/${data.activityDetailId}" title="Edit"
                                           data-rel="tooltip">
                                        ...
                                        <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                           ...
                                           data-id="${data.activityDetailId}" data-rel="tooltip">
