...
public class HotelDetailImpl extends JdbcTemplate implements HotelDetailDao {
    ...
    public List procHotelDetail(String hotelDetailId, String hotelName, String hotelPhNo1, String hotelPhNo2,
                                ...
                                String personalPhNo, String personalEmailId, String areaId, String
                                        clientDetailId, String url, String user, String flag) {
        ...
        call.addDeclaredParameter(new SqlParameter("IN_PERSONAL_DETAIL", Types.VARCHAR));
        call.addDeclaredParameter(new SqlParameter("IN_PERSONAL_PH_NO", Types.NUMERIC));
        call.addDeclaredParameter(new SqlParameter("IN_PERSONAL_EMAIL_ID", Types.VARCHAR));
        ...
        inp.put("IN_PERSONAL_DETAIL", personalDetail);
        inp.put("IN_PERSONAL_PH_NO", personalPhNo);
        inp.put("IN_PERSONAL_EMAIL_ID", personalEmailId);
