...
@Component
@Path("/roomDetail")
public class RoomDetailResource {
    ...
    public Response checkNumberRegistered(CustomerDetailModel customerDetailModel) {
        ...
        List<CustomerDetailModel> customerDetailModels = new CustomerDetailMapper().mapList(customerDetailDao.procCustomerDetail(null, null, null,null, null, customerDetailModel.getContactNo(), null, null, null, null, null, null, null, null, null, null, "s"));
