...
public class ActivityMapper {
    ...
    public ActivityModel mapRow(Map map) {
        ...
        activityModel.setActivityId(map.get("activity_id")==null? null:map.get("activity_id").toString() );
        activityModel.setParentActivityId(map.get("parent_activity_id")==null? null:map.get("parent_activity_id").toString());
        activityModel.setActivityDesc(map.get("activity_desc")==null? null:map.get("activity_desc").toString());
        ...
        activityModel.setTotal(map.get("total")==null? null:map.get("total").toString());
