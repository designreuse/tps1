				...
				<tbody>
					<c:forEach items="${fileList}" var="dataFile" varStatus="loopCounter">
						<tr>
							...
							<td><c:out value="${dataFile.fileName}" /></td>
							<td><c:out value="${dataFile.fileType}" /></td>
							...
							<td>
								<a class="btn btn-primary" href="${pageContext.request.contextPath}/get/${dataFile.hotelImageId}">
