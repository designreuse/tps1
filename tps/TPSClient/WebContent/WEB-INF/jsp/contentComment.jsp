        ...
        <div class="wrapper wrapper-content animated fadeIn">
            <div class="row">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <c:forEach items="${contentCommentList}" var="data" varStatus="count">
                        ...
                        <tr>
                            ...
                            <td>${data.type}</td>
                            <td><input type="checkbox" name="active" class="i-checks active1" <c:if test="${data.active=='Y'}">checked</c:if> value="${data.contentCommentId}" id="checkbox${count.count}"></td>
                            <td><img src="http://${pageContext.request.serverName}:${pageContext.request.serverPort}/TPSResources/icons/${data.image}" alt="${data.payGateDesc} logo" width="50" height="50">
                                <a class="upload-link" data-id="${data.contentCommentId}" data-type="${data.type}">Change Logo</a> </td>
                           <%-- <td class="center">

                                <a class="btn btn-info" href="edit/${data.contentCommentId}" title="Edit"
                                   data-rel="tooltip">
                                ...
                                <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                   ...
                                   data-id="${data.contentCommentId}" data-rel="tooltip">
                ...
                <form action="iconUpload" id="iconUploadForm" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="contentCommentId" id="payGateAccesId">
...
<script type="text/javascript">
    ...
    $(".active1").change(function(){
        ...
        $.ajax({
            method: "POST",
            url: "update",
            data: {contentCommentId: $(this).val(), active: activeStatus},
            dataType: "json",
            beforeSend: function () {
