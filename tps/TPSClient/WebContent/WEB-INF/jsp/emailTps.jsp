        ...
        <div class="wrapper wrapper-content animated fadeIn">
                ...
                <div class="p-w-md m-t-sm">
                    <div class="row update-form">
                        ...
                        <form id="form1" class="form-horizontal" method="post" action="${mode}">
                            ...
                            <input type="hidden" name="emailTpsId" value="${emailTpsMap.emailTpsId}">


                            <div class="form-group"><label class="col-sm-2 control-label">EmailAddress</label>

                                <div class="col-sm-3"><input type="text" class="form-control"
                                                             placeholder="Email Address" id="emailAddress" name="emailAddress"
                                                             type="text" value="${emailTpsMap.emailAddress}" required></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Active</label>

                                <div class="col-sm-3"><input type="checkbox" name="active" <c:if test="${emailTpsMap.active=='Y'}">checked</c:if> value="Y" id="checkbox${count.count}"></div>
                            </div>
            ...
            <div class="row">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <c:forEach items="${emailTpsList}" var="data" varStatus="count">
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="edit/${data.emailTpsId}" title="Edit"
                                   data-rel="tooltip">
                                ...
                                <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                   ...
                                   data-id="${data.emailTpsId}" data-rel="tooltip">
