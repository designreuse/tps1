                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <c:forEach items="${hotelDetailList}" var="data" varStatus="count">
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="active" <c:if test="${data.active=='Y'}">checked</c:if> value="${data.active}" id="checkbox${count.count}"></td>
                            <td class="center">
        ...
        <div class="row">
            <div>
                <form class="form-horizontal" method="post" action="<c:choose><c:when test="${base!=null}">update</c:when><c:otherwise>hotelDetail/update</c:otherwise></c:choose> " id="propertyDetailForm">
                    ...
                    <c:if test="${base==null}"> value="1" </c:if> >
                    ...
                    <div class="form-group" id="parentAddress"><label class="col-sm-2 control-label">Address</label>
                        ...
                        <div class="col-sm-10">
                            ...
                            <c:forEach items="${keyList}" var="keyValue" varStatus="index">
                                ...
                                <div class="col-sm-2 addres"><small>${key}</small><select <c:if test="${index.count eq fn:length(keyList)}"> name="addressId" </c:if> class="form-control m-b" required id="address${index.count}">
                                    <option value="">Select</option>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Active</label>
                        ...
                        <div class="col-sm-3"><input type="checkbox" name="active" <c:if test="${hotelDetailMap.active=='Y'}">checked</c:if> value="${data.active}" id="checkbox${count.count}"></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div id="map">
