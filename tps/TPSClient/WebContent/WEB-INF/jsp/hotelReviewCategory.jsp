        ...
        <div class="wrapper wrapper-content animated fadeIn">
                ...
                <div class="p-w-md m-t-sm">
                    <div class="row update-form">
                        ...
                        <form id="form1" class="form-horizontal" method="post" action="${mode}">
                            ...
                            <input type="hidden" name="hotelReviewCategoryId" value="${hotelReviewCategoryMap.hotelReviewCategoryId}">


                            <div class="form-group"><label class="col-sm-2 control-label">Description</label>

                                <div class="col-sm-3"><input type="text" class="form-control"
                                                             placeholder="Description" id="categoryDesc" name="categoryDesc"
                                                             type="text" value="${hotelReviewCategoryMap.categoryDesc}" required></div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label">Active</label>
                                <div class="col-sm-3"><input type="checkbox" name="active" value="Y"
                                                             <c:if test="${hotelReviewCategoryMap.active=='Y'}"> checked</c:if> ></div>
                            </div>
            ...
            <div class="row">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <c:forEach items="${hotelReviewCategoryList}" var="data" varStatus="count">
                        ...
                        <tr>
                            ...
                            <td class="center">
                                    <a class="btn btn-info" href="edit/${data.hotelReviewCategoryId}" title="Edit"
                                       data-rel="tooltip">
                                    ...
                                    <a class="open btn btn-danger" title="Delete" data-toggle="modal"
                                       ...
                                       data-id="${data.hotelReviewCategoryId}" data-rel="tooltip">
