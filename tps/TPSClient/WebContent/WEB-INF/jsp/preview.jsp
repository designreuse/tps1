            ...
            <div class="col-lg-12">
                ...
                <form action="" id="accept" method="post" class="form-horizontal">
                    ...
                    <c:if test="${action eq 'approved'}">
                        <div class="form-group" style="display: none" id="div-remarks"><label class="col-sm-2 control-label">Remarks</label>
                        ...
                        <div class="col-sm-4 col-sm-offset-2">
                            ...
                            <button type="submit" class="btn btn-default" id="btn-reject">Reject</button>
                        </div>
                    </c:if>
...
//    alert("ganga");
    if($("#div-remarks").is(":visible")){

        $("#accept").attr("action", "rejectContent").submit();
    ...
    $("#div-remarks").show();
/*//    $(this).attr("id","rejectContent");
    $(this).attr("type","submit");
    $(this).attr("formaction","rejectContent");*/


});
/*$('body').on('click', '#rejectContent', function () {
