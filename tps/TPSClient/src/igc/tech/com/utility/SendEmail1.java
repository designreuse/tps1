...
//						}
    ...
    /*    Map map = new HashMap();
        ...
        list.add(map);
    */    System.out.println(new SendEmail1().access("IGC Testing", "igctesting123@gmail.com", "igctesting@123",
                "smtp.gmail.com", "465", "tilakpeace0000@gmail.com", "test", "hello", new ArrayList<Map>()));
