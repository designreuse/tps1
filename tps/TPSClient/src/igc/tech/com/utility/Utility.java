...
public class Utility {
    ...
    public List<Map> jsList(String[] jsArray){
    ...
    public  void check(EasyTreeModel easyTreeModel, List<EasyTreeModel> easyTreeModelList){

        List<EasyTreeModel> easyTreeModelList1=new ArrayList<>();

        int count=0;

        while (!(easyTreeModelList.size()==count) ){

            EasyTreeModel easyTreeModel1=easyTreeModelList.get(count);

            if (easyTreeModel1.getParent().equals(easyTreeModel.getId())){

                easyTreeModelList1.add(easyTreeModel1);
                easyTreeModelList.remove(count);
            }
            else
            {
                count++;
        ...
        if (!easyTreeModelList.isEmpty()){

            easyTreeModel.setChildren(easyTreeModelList1);

            for(EasyTreeModel easyTreeModel1:easyTreeModel.getChildren()){

                check(easyTreeModel1,easyTreeModelList);
            }
        }
