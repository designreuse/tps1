...
public class AmenityMapper {
    ...
    public AmenityModel mapRow(Map map) {
        ...
        amenityModel.setAmenityId(map.get("amenity_id").toString());
        amenityModel.setParentAmenityId(map.get("parent_amenity_id")==null?"0":map.get("parent_amenity_id").toString());
        amenityModel.setAmenityDesc(map.get("amenity_desc").toString());
        ...
        amenityModel.setImage(map.get("image")==null?null:map.get("image").toString());
