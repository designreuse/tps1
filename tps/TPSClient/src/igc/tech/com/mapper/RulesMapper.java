...
public class RulesMapper {
    ...
    public RulesModel mapRow(Map map) {
        ...
        rulesModel.setRulesDesc(map.get("rules_desc")==null?null:map.get("rules_desc").toString());
        rulesModel.setType(map.get("type").toString());
        rulesModel.setHotelDetailId(map.get("hotel_detail_id")==null? null:map.get("hotel_detail_id").toString());
