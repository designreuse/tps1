...
public class HotelDetailDaoImpl extends JdbcTemplate implements HotelDetailDao {
    ...
    public List procHotelDetail(HotelDetailModel hotelDetailModel, String user, String flag) {
        ...
        call.addDeclaredParameter(new SqlParameter("in_hotel_ph_no_1", Types.VARCHAR));
        call.addDeclaredParameter(new SqlParameter("in_hotel_ph_no_2", Types.VARCHAR));
        call.addDeclaredParameter(new SqlParameter("in_hotel_ph_no_3", Types.VARCHAR));
        ...
        inp.put("in_description", hotelDetailModel.getDescription());
