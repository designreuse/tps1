 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "nPAY", wsdlLocation = "https://gateway.sandbox.npay.com.np/websrv/Service.asmx?WSDL")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("nPAY", "Service");
    ...
    static {
        ...
        try {
            url = new URL("https://gateway.sandbox.npay.com.np/websrv/Service.asmx?WSDL");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("nPAY", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("nPAY", "ServiceSoap"), ServiceSoap.class, features);
    }
