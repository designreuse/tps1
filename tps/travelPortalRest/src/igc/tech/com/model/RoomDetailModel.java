...
public class RoomDetailModel {
    ...
    private List<AmenityHighlightModel> amenityHighlightList;
    ...
    public List<AmenityHighlightModel> getAmenityHighlightList() {
        return amenityHighlightList;
    }

    public void setAmenityHighlightList(List<AmenityHighlightModel> amenityHighlightList) {
        this.amenityHighlightList = amenityHighlightList;
    }
    ...
    public String toString() {
        return "RoomDetailModel{" +
                ...
                ", roomImportanceList=" + roomImportanceList +
                ", activityHighlightList=" + activityHighlightList +
                ", amenityHighlightList=" + amenityHighlightList +
                ", address=" + address +
