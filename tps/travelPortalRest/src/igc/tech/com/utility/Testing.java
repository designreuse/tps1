...
public class Testing {
    ...
    public static void main(String[] args) {
       /* List<Employee> employees=new ArrayList<>();
        ...
        String val="Lazimpat,Kathmandu,Bagmati,Central Development Region,Nepal";

       // System.out.println(val);

        List<String> addressList = Arrays.asList(val.split(","));

        System.out.println(addressList.get(0)+", "+addressList.get(1));
