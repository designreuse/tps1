...
//						}
    ...
    /*    Map map = new HashMap();
        ...
        list.add(map);
    */    System.out.println(new SendEmail().access("IGC Testing", "igctesting123@gmail.com", "igctesting@123",
                "smtp.gmail.com", "587", "tilakpeace0000@gmail.com", "test", "hello", new ArrayList<Map>()));
