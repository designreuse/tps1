...
public class OfferDaoImpl extends JdbcTemplate implements OfferDao {
    ...
    public List procOffer(OfferModel offerModel, String user, String flag) {
        ...
        call.addDeclaredParameter(new SqlParameter("in_booking_from", Types.VARCHAR));
        call.addDeclaredParameter(new SqlParameter("in_booking_to", Types.VARCHAR));
        ...
        inp.put("in_booking_from", offerModel.getBookingFrom());
        inp.put("in_booking_to", offerModel.getBookingTo());
