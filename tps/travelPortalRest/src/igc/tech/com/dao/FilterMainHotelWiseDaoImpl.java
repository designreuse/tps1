...
public class FilterMainHotelWiseDaoImpl extends JdbcTemplate implements FilterMainHotelWiseDao {

    @Override
    public Map<String, Object> procFilterMainHotelWise(HotelFilterModel hotelFilterModel) {


        String procName = "proc_filter_main_hotelwise";
        ...
        inp.put("in_currency_desc", hotelFilterModel.getCurrencyDesc());
