...
public class Resource1 {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Response mobNav1() throws Exception {

        errorMessage=new ErrorMessage();
        errorMessage.setStatus("tilak testing");
        errorMessage.setErrorCode("0000");
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Response mobNav2() throws Exception {

        errorMessage=new ErrorMessage();
        Response response= mobNav1();
        errorMessage= (ErrorMessage) response.getEntity();
