...
public class Validation {
	...
	public List<ValidData> test(List<ValidData> validDatas){
		...
		ValidType validType=validData.getValidType();
			...
			if (validType.isRequired()){
				if (!requiredField(validData.getValue())){
					validData.getErrorMessageList().add("Required");
				}
			...
			{
				if(!(validData.getValue()==null || validData.getValue().trim().isEmpty()) ){
...
*/
	...
	public  void  test2( ValidData validData){
